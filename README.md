# Pre-release of SGConv

Please email me (tianle.cai@princeton.edu) if you have any questions.
...
### Full code
We modified the S4 codebase to support SGConv. Please see the configuration files in *configs/experiment/lra* for examples. The source code is located in *src/models/sequence/gconv.py*. Please refer to the instructions from the original repo (attached below) to run the experiments.
